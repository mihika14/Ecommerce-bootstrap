...
const Index = () => {
  return (
    <>
      ...
      <Header />
      <Hero collection_brand={'fhsgfjhdsfgsdghfgdfgsdfgsdfgsdhfsdghjsdgfhsdfgfgdsjfgsdfgsdhfg'} collection_name={'fhdjskfhdskjfhsdjkf'} collection_url={'/'} image_url={'https://images.pexels.com/photos/1287145/pexels-photo-1287145.jpeg'}/>
      <Footer />
