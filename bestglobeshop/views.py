...
from app.models import Category, Product, contact_us, Order, Brand, Blog, Size, Color, SubCategory
...
def item_increment(request, id):
    ...
    product_db = e.objects.get(id=id)
    product_db.quatity += 1 
    product_db.total = product_db.quatity * product_db.price
    product_db.save()
    return redirect("cart_detail")
